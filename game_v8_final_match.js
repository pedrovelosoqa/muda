...
(() => {
  ...
  class AssetBuilder {
    ...
    static createFallbackTextures(scene) {
      this.generateTexture(scene, "gatinha", 96, 58, (g) => {
  ...
  class HUDController {
    ...
    reflowLives(count, width) {
      ...
      for (let index = 0; index < maxIcons; index += 1) {
        const icon = this.scene.add.image(rightX + (index * 24), 34, "gatinha").setOrigin(0, 0.5);
  ...
  class BootScene extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.image("gatinha", "./gatinha.png");
  ...
  class MenuScene extends Phaser.Scene {
    ...
    createPlayButton() {
      ...
      this.playButtonIcon = this.add.image(-82, 0, "gatinha").setDisplaySize(34, 22);
