...
(() => {
  ...
  class MudaPlayer {
    constructor(scene, config) {
      ...
      this.glowSprite = scene.add.image(0, 0, this.textureKey).setTint(0xffffff).setAlpha(0.22).setScale(1.12);
      this.shadowSprite = scene.add.image(2, 3, this.textureKey).setTint(0x050505).setAlpha(0.34).setScale(1.08);
      this.outlineSprite = scene.add.image(0, 0, this.textureKey).setTint(0x000000).setAlpha(1).setScale(1.07);
