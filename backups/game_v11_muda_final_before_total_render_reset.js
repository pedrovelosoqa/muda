...
(() => {
  ...
  class HUDController {
    ...
    reflowLives(count, width) {
      ...
      for (let index = 0; index < maxIcons; index += 1) {
        const icon = this.scene.add.image(rightX + (index * 24), 34, "muda_final").setOrigin(0, 0.5);
  ...
  class BootScene extends Phaser.Scene {
    ...
    preload() {
      ...
      this.load.image("muda_final", "./gatinha.png");
  ...
  class MenuScene extends Phaser.Scene {
    ...
    createPlayButton() {
      ...
      this.playButtonIcon = this.add.image(-82, 0, "muda_final").setDisplaySize(34, 22);
