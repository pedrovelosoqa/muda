/*
  ...
  Rollback:
  - As versoes anteriores continuam preservadas na pasta backups/ e em game_v7_visualmatch.js.
  - Esta iteracao integrada foi salva separadamente em game_v8_final_match.js.
*/

(() => {
  const GAME_VERSION = "v8_final_match";
  ...
  class MenuScene extends Phaser.Scene {
    ...
    createPlayButton() {
      ...
      this.footer = this.add.text(
        ...
        "Versao visual: game_v8_final_match.js | Rollbacks anteriores preservados",
        {
          fontFamily: "Trebuchet MS, Verdana, sans-serif",
          fontSize: "13px",
          color: "#dbeafe"
