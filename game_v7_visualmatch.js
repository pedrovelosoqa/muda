/*
  ...
  Rollback:
  - As versoes anteriores continuam preservadas em game.js, game_v2_backup.js, game_v3.js, game_v4_balanced.js, game_v5_invincibility.js e game_v6_final.js.
  - Esta iteracao visual foi salva separadamente em game_v7_visualmatch.js.
*/

(() => {
  const GAME_VERSION = "v7_visualmatch";
  ...
  class MenuScene extends Phaser.Scene {
    ...
    createPlayButton() {
      ...
      this.footer = this.add.text(
        ...
        "Versao visual: game_v7_visualmatch.js | Rollbacks anteriores preservados",
        {
          fontFamily: "Trebuchet MS, Verdana, sans-serif",
          fontSize: "13px",
          color: "#dbeafe"
