/*
  ...
  - Esta iteracao com gatinha.png puro foi salva separadamente em game_v10_gatinha_pura.js.
*/

(() => {
  const GAME_VERSION = "v10_gatinha_pura";
  ...
  class MenuScene extends Phaser.Scene {
    ...
    createPlayButton() {
      ...
      this.footer = this.add.text(
        ...
        "Versao visual: game_v10_gatinha_pura.js | Rollbacks anteriores preservados",
        {
          fontFamily: "Trebuchet MS, Verdana, sans-serif",
          fontSize: "13px",
          color: "#dbeafe"
